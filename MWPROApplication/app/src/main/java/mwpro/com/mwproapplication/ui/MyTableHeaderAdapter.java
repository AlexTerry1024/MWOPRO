...
/**
 * The abstract implementation of an adapter used to bring data to a {@link MyTableHeaderView}.
 *
 * @author ISchwarz
 */
public abstract class MyTableHeaderAdapter extends ArrayAdapter {
     ...
     */
    public MyTableHeaderAdapter(final Context context) {
        this(context, 0);
    }
     ...
     */
    protected MyTableHeaderAdapter(final Context context, final int columnCount) {
     ...
     */
    protected MyTableHeaderAdapter(final Context context, final TableColumnModel columnModel) {
        super(context, 0);
