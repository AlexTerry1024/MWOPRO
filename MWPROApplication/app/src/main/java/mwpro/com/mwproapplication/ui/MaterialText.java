...
public class MaterialText extends FrameLayout {
    ...
    public void setLabelText(String strContent)
    {
        if(label != null)
            label.setText(strContent);
    }
    public MaterialText(Context context, AttributeSet attrs) {
        super(context, attrs);
        handleAttributes(context, attrs);
        init();
    }

    public MaterialText(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            ViewCompat.animate(editText)
                    ...
                    .setUpdateListener(new ViewPropertyAnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(View view) {
                            ...
                            card.getLayoutParams().height = (int) (value * (heightInitial - cardCollapsedHeight) + cardCollapsedHeight + 10);
                            card.requestLayout();
                        }
                    })
                    .setDuration(ANIMATION_DURATION)
