 ...
 * @author ISchwarz
 */
public final class MySimpleTableHeaderAdapter extends MyTableHeaderAdapter {
     ...
     */
    public MySimpleTableHeaderAdapter(final Context context, final String... headers) {
        super(context);
        this.headers = headers;
    }

    public MySimpleTableHeaderAdapter(final Context context, final int... headerStringResources) {
        super(context);
